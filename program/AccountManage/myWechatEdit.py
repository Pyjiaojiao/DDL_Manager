...
class WechatWidget(QWidget):
    def __init__(self):
        super(WechatWidget, self).__init__()
        self.setupUi()
    ...
    def setupUi(self):
        ...
        self.graphicsView_2.setStyleSheet("background-image: url(:/AccountManagement_wechat.png);\n"
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("Form", "微信绑定"))
