...
class NewTaskDialog(QWidget):
    ...
    def initUi(self):
        ...
        self.checkBox.setGeometry(QtCore.QRect(70, 130, 200, 40))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        # timeEdit:预期用时(Hour)
        self.timeEdit.setGeometry(QtCore.QRect(230, 190, 150, 40))
        font = QtGui.QFont()
        font.setFamily("微软雅黑 Light")
        font.setBold(False)
        font.setWeight(50)
        ...
        # lineEdit_3:预期用时(RestMinute)
        # self.dateTimeEdit.setGeometry(QtCore.QRect(230, 190, 200, 30))
        # sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        # sizePolicy.setHorizontalStretch(0)
        # sizePolicy.setVerticalStretch(0)
        ...
        # self.dateTimeEdit.setStyleSheet("background-color:rgb(238, 238, 238);\n"
        #                                 "border-radius:5px\n"
        #                                 "")
        ...
        self.dateTimeEdit_2.setGeometry(QtCore.QRect(230, 250, 200, 30))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.dateTimeEdit_2.setStyleSheet("background-color:rgb(238, 238, 238);\n"
                                          "border-radius:5px")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "预计用时"))
        ...
        self.comboBox_2.setItemText(0, _translate("MainWindow", "非常重要"))
        self.comboBox_2.setItemText(1, _translate("MainWindow", "重要"))
        self.comboBox_2.setItemText(2, _translate("MainWindow", "一般"))
        self.comboBox_2.setItemText(3, _translate("MainWindow", "不重要"))
